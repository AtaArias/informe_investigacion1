...
Las muestras de TEM deben ser extremadamente delgadas y el pequeño tamaño de las partículas, que podría ser inconveniente en otro sistema, las vuelve ideales para analizar mediante TEM.

En microscopia electrónica de transmisión se incide sobre una muestra con un haz de electrones de alta energía. 
...
%	-- Lentes objetivo --
Luego de ser condensado el haz recorre la lentes objetivo, las cuales se encargan de enfocar el haz sobre la muestra. Aquí es donde aparecen los 
...
% TODO: Redactar el armado del portamuestras
En el centro de la columna se encuentra el porta muestra Fig. \ref{fig:portamuestras}. 
Sobre esta se prepara la muestra a analizar. 
El haz de electrones atraviesa la muestra, aquí interaciona con los átomos que lo forman y detrás se obtiene el haz de electros post-interación.

% 	-- Lentes proyectoras --
Debajo del portamuestra se encuentran la lentes que forman la imágen. 
Su tarea es enfocar el haz de salida sobre la pantalla. 
Aquí es donde se realiza toda la magnificación.

% 	-- Pantalla y cámara --
% TODO: Agregar él modelo de la cámara.
La columna posee una pantalla fluorescente para analizar las imágenes en vivo y también posée de una cámara CCD Gatan no se cuanto.
